; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Documents and Settings\Jorge Fernandez\Desktop\Sistemas Operativos I\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial16\SysCore\Kernel\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
?logo@@3PADA DD	FLAT:$SG2689				; logo
_DATA	ENDS
CONST	SEGMENT
$SG2689	DB	'    __  _______  _____', 0aH, '   /  |/  / __ \/ ___/', 0aH
	DB	'  / /|_/ / / / /\__ \ Microcomputer Operating System ', 0aH, ' '
	DB	'/ /  / / /_/ /___/ / -------------------------------', 0aH, '/'
	DB	'_/  /_/\____//____/  ', 0aH, 0aH, 00H
	ORG $+1
$SG2728	DB	'Weee.... The PIC, PIT, and exception handlers are instal'
	DB	'led!', 0aH, 0aH, 00H
	ORG $+1
$SG2729	DB	'Hitting any key will fire the default HAL handlers as we'
	DB	' do', 0aH, 00H
	ORG $+3
$SG2730	DB	'not have a keyboard driver yet to install one.', 0aH, 0aH
	DB	00H
	ORG $+3
$SG2731	DB	'Cpu vender: %s ', 0aH, 0aH, 00H
	ORG $+2
$SG2735	DB	'Current tick count: %i', 00H
CONST	ENDS
PUBLIC	_main
...
; File c:\documents and settings\jorge fernandez\desktop\sistemas operativos i\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial16\syscore\kernel\main.cpp
_TEXT	SEGMENT
_main	PROC
