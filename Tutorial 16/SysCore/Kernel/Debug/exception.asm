; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Documents and Settings\Jorge Fernandez\Desktop\Sistemas Operativos I\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial16\SysCore\Kernel\exception.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG2681	DB	'Divide by 0', 00H
$SG2690	DB	'Single step', 00H
$SG2699	DB	'NMI trap', 00H
	ORG $+3
$SG2708	DB	'Breakpoint trap', 00H
$SG2717	DB	'Overflow trap', 00H
	ORG $+2
$SG2726	DB	'Bounds check fault', 00H
	ORG $+1
$SG2735	DB	'Invalid opcode', 00H
	ORG $+1
$SG2744	DB	'Device not found', 00H
	ORG $+3
$SG2754	DB	'Double fault', 00H
	ORG $+3
$SG2764	DB	'Invalid TSS', 00H
$SG2774	DB	'Invalid segment', 00H
$SG2784	DB	'Stack fault', 00H
$SG2794	DB	'General Protection Fault', 00H
	ORG $+3
$SG2804	DB	'Page Fault', 00H
	ORG $+1
$SG2813	DB	'FPU Fault', 00H
	ORG $+2
$SG2823	DB	'Alignment Check', 00H
$SG2832	DB	'Machine Check', 00H
	ORG $+2
$SG2841	DB	'FPU SIMD fault', 00H
CONST	ENDS
PUBLIC	?divide_by_zero_fault@@YAXIII@Z			; divide_by_zero_fault
EXTRN	?kernel_panic@@YAXPBDZZ:PROC			; kernel_panic
; Function compile flags: /Ogtpy
; File c:\documents and settings\jorge fernandez\desktop\sistemas operativos i\2016-ii-1272-so1-osdevseries-jorgefer00\tutorial16\syscore\kernel\exception.cpp
_TEXT	SEGMENT
_cs$ = 8						; size = 4
_eip$ = 12						; size = 4
_eflags$ = 16						; size = 4
